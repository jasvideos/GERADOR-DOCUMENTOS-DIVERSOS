...
const TUTORIAL_STEPS = [
  ...
  },
  {
    ...
    narration: 'Na aba de Resumo Profissional, escreva um parágrafo curto sobre você. Destaque seus anos de experiência, principais habilidades e o que você tem a oferecer para a empresa. Seja objetivo e impactante!',
  ...
  },
  {
    ...
    field: null,
    value: null,
    narration: 'Agora vamos para a aba de Experiência Profissional. Aqui você lista os empregos anteriores do mais recente para o mais antigo. Quanto mais detalhada a descrição das suas responsabilidades e conquistas, melhor!',
    label: 'Aba: Experiência',
  },
  {
    tab: 'Formação',
    field: null,
    value: null,
    narration: 'Na aba de Formação Acadêmica, liste seus cursos do mais recente para o mais antigo. Inclua faculdades, cursos técnicos e certificações relevantes.',
    label: 'Aba: Formação',
  },
  {
    tab: 'Idiomas',
  ...
  },
  {
    ...
    field: null,
    value: null,
    narration: 'Na aba de Habilidades, você pode adicionar competências técnicas e comportamentais. Exemplos: Excel, Photoshop, Trabalho em equipe, Liderança. Seja honesto e liste o que realmente domina.',
    label: 'Aba: Habilidades',
  },
  {
    tab: 'Habilidades',
    field: null,
...
const TutorialCurriculo = ({ onClose, onApplyData }) => {
  ...
  const ABA_CAMPOS = {
    ...
    'Experiência': [
      { key: null, label: 'Liste seus empregos anteriores', info: true },
      { key: null, label: 'Do mais recente para o mais antigo', info: true },
      { key: null, label: 'Inclua cargo, empresa, período e atividades', info: true },
    ],
    'Formação': [
      { key: null, label: 'Liste sua formação acadêmica', info: true },
      { key: null, label: 'Inclua cursos técnicos e certificações', info: true },
    ],
    'Idiomas': [
    ...
    'Habilidades': [
      { key: null, label: 'Liste habilidades técnicas e comportamentais', info: true },
      { key: null, label: 'Ex: Excel, Liderança, Trabalho em equipe', info: true },
    ],
  };
